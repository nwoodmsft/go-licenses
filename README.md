...
```shell
go install github.com/nwoodmsft/go-licenses@latest
```
...
```shell
$ go-licenses report github.com/nwoodmsft/go-licenses
...
W0410 06:02:59.872215   31529 library.go:253] module github.com/nwoodmsft/go-licenses has empty version, defaults to HEAD. The license URL may be incorrect. Please verify!
W0410 06:02:59.880621   31529 library.go:253] module github.com/nwoodmsft/go-licenses has empty version, defaults to HEAD. The license URL may be incorrect. Please verify!
...
github.com/nwoodmsft/go-licenses,https://github.com/nwoodmsft/go-licenses/blob/HEAD/LICENSE,Apache-2.0
github.com/nwoodmsft/go-licenses/internal/third_party/pkgsite,https://github.com/nwoodmsft/go-licenses/blob/HEAD/internal/third_party/pkgsite/LICENSE,BSD-3-Clause
...
```bash
go-licenses report github.com/nwoodmsft/go-licenses > licenses.csv
```

Or, to also save error logs to an `errors` file, run:

```bash
go-licenses report github.com/nwoodmsft/go-licenses > licenses.csv 2> errors
```
...
```shell
go-licenses report github.com/nwoodmsft/go-licenses --template testdata/modules/hello01/licenses.tpl
...
W0822 16:56:51.602250   10200 library.go:269] module github.com/nwoodmsft/go-licenses has empty version, defaults to HEAD. The license URL may be incorrect. Please verify!
W0822 16:56:51.605074   10200 library.go:269] module github.com/nwoodmsft/go-licenses has empty version, defaults to HEAD. The license URL may be incorrect. Please verify!
 ...
 - github.com/nwoodmsft/go-licenses ([Apache-2.0](https://github.com/nwoodmsft/go-licenses/blob/HEAD/LICENSE))
 - github.com/nwoodmsft/go-licenses/internal/third_party/pkgsite ([BSD-3-Clause](https://github.com/nwoodmsft/go-licenses/blob/HEAD/internal/third_party/pkgsite/LICENSE))
...
```shell
go-licenses save "github.com/nwoodmsft/go-licenses" --save_path="/tmp/go-licenses-cli"
```
...
* A rooted import path like `github.com/nwoodmsft/go-licenses` or `github.com/nwoodmsft/go-licenses/licenses`.
...
Welcome [creating an issue](https://github.com/nwoodmsft/go-licenses/issues).
